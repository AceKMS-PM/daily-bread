  ...
  return (
    ...
    >
      <div className="aspect-square bg-sacred-deeper rounded-xl overflow-hidden border relative"
        style={{ borderColor: "rgba(var(--gold-rgb),0.1)" }}
      >
        <img
      ...
      {!compact && (
        <div className="mt-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="font-sans text-xs tracking-wide" style={{ color: "rgba(var(--gold-rgb),0.7)" }}>
              {ref}
            </span>
          ...
          <p className="font-serif text-sm line-clamp-2" style={{ color: "rgba(var(--text-rgb),0.65)", lineHeight: 1.6 }}>
      ...
      <div className="p-8">
        <div className="flex items-center gap-4 mb-4">
          <span
            ...
            style={{ color: "var(--gold)", borderColor: "rgba(var(--gold-rgb),0.15)" }}
          >
            {tag}
          </span>
          <span className="font-sans text-xs italic" style={{ color: "rgba(var(--text-rgb),0.55)" }}>
            {dateLabel}
          </span>
        </div>
        <h3
          className="font-display mb-4 group-hover:text-gradient-gold transition-all duration-300"
          style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "var(--parchment-100)", lineHeight: 1.2 }}
        >
          {devotional.title}
        </h3>
        <p className="font-serif text-base line-clamp-3 mb-8" style={{ color: "rgba(var(--text-rgb),0.65)", lineHeight: 1.7 }}>
